...
NIX_CFLAGS_COMPILE=' -frandom-seed=787p0a42dk -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include'
...
XDG_DATA_DIRS='/nix/store/dddwfz7nph37q3cjky9lhpy9kb90rrrx-bash-interactive-5.3p15/share:/nix/store/swljvs2gz4mcb1avyjzb0cc2qrbslmbb-pkg-config-wrapper-0.29.2/share:/nix/store/f13cgj4sypbjrwwpshfc2x4fd11is8dp-patchelf-0.15.2/share'
...
NIX_LDFLAGS='-rpath /nix/store/787p0a42dk8qxzpz0yjm4dgzamawq9v9-devenv-shell-env/lib '
export NIX_LDFLAGS
...
DEVENV_PROFILE='/nix/store/a7dg8z419c4j7iwhxj0qmkqfsydladma-devenv-profile'
...
nativeBuildInputs='/nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev /nix/store/swljvs2gz4mcb1avyjzb0cc2qrbslmbb-pkg-config-wrapper-0.29.2'
...
DEVENV_RUNTIME='/run/user/1000/devenv-7393383'
...
out='/nix/store/787p0a42dk8qxzpz0yjm4dgzamawq9v9-devenv-shell-env'
export out
AR='ar'
export AR
STRINGS='strings'
...
DEVENV_ROOT='/home/htnk/Developments/github.com/2gn/nix-repo-2gn'
export DEVENV_ROOT
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/mp8s10fwm685azvvv1qq7zyf7iajjlj8-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/a7dg8z419c4j7iwhxj0qmkqfsydladma-devenv-profile" ]
then
  ln -snf /nix/store/a7dg8z419c4j7iwhxj0qmkqfsydladma-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-7393383
ln -snf /run/user/1000/devenv-7393383 /home/htnk/Developments/github.com/2gn/nix-repo-2gn/.devenv/run


echo "✨ devenv 2.2.2 is newer than devenv input (2.2.0) in devenv.lock. Run '\''devenv update'\'' to sync." >&2


# Check whether the direnv integration is out of date.
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/htnk/Developments/github.com/2gn/nix-repo-2gn:"* ]]; then
...
exec /tmp/devenv-envfXbu1R/script 