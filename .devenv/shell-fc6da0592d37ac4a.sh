...
NIX_CFLAGS_COMPILE=' -frandom-seed=nw8bp9dbzj -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include'
...
outputBin='out'
NIX_LDFLAGS='-rpath /nix/store/nw8bp9dbzj741ki8b5adyhj56fc5jmby-devenv-shell-env/lib '
export NIX_LDFLAGS
...
SIZE='size'
export SIZE
out='/nix/store/nw8bp9dbzj741ki8b5adyhj56fc5jmby-devenv-shell-env'
export out
strictDeps=''
export strictDeps
...
export STRIP
outputInclude='out'
prefix='/nix/store/nw8bp9dbzj741ki8b5adyhj56fc5jmby-devenv-shell-env'
...
exec /tmp/devenv-envuh6aVQ/script 